<%-- 
    Document   : cart
    Created on : Oct 17, 2023, 10:30:13 PM
    Author     : TGDD
--%>
                                ...
                                <div class="coupon_code right">
                                    ...
                                    <div class="coupon_inner">
                                        ...
                                        <div class="cart_subtotal ">
                                            ...
                                            <p class="cart_amount">${(sessionScope.total==0 ? 0:30000)}</p>
                                        </div>

                                        <div class="cart_subtotal">
                                            <p>Total</p>
                                            <p class="cart_amount"><fmt:formatNumber pattern="##########" value="${sessionScope.total + (sessionScope.total==0 ? 0:30000) }"/></p>
                                        </div>
